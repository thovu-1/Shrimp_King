...
class Crystal_Black(Shrimp):
    ...
    def load_sprites(self):
        d = {}
        # Load sprite sheets
        shrimplet_sprite_sheet = pygame.image.load('shrimp_images/Shrimplet_Crystal_Black.png').convert_alpha()
        juvenile_sprite_sheet = pygame.image.load('shrimp_images/Juvenile_Crystal_Black.png').convert_alpha()
        adult_sprite_sheet = pygame.image.load('shrimp_images/Adult_Crystal_Black.png').convert_alpha()

        # Load frame data from JSON files
        with open('shrimp_images/Shrimplet_Crystal_Black.json') as f:
            shrimplet_data = json.load(f)
        with open('shrimp_images/Juvenile_Crystal_Black.json') as f:
            juvenile_data = json.load(f)
        with open('shrimp_images/Adult_Crystal_Black.json') as f:
